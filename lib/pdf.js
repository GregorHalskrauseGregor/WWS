...
//
// WICHTIG: pdfkit wird NICHT am Modul-Anfang geladen, sondern erst bei der
// ersten PDF-Erstellung. Grund: pdfkit hat eine optionale Dependency `canvas`,
// die in manchen Umgebungen (z.B. Railway ohne Canvas-Build) DOMMatrix-Fehler
// wirft. Lazy-Loading hält das Modul selbst sauber und der Fehler kommt
// erst, wenn auch wirklich ein PDF gebraucht wird.
...
async function erstelleAufmass(daten, outputPath) {
  // Lazy-Load: pdfkit erst hier laden, nicht am Modul-Anfang. Siehe
  // Kommentar oben — die optionale canvas-Dependency wirft sonst beim
  // Modul-Load DOMMatrix-Fehler, obwohl wir das gar nicht brauchen.
